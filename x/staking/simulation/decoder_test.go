...
func TestDecodeStore(t *testing.T) {
	...
	ubd := types.NewUnbondingDelegation(delAddr1, valAddr1, 15, bondTime, sdk.NewCoin(sdk.DefaultBondDenom, sdk.OneInt()))
	red := types.NewRedelegation(delAddr1, valAddr1, valAddr1, 12, bondTime, sdk.NewCoin(sdk.DefaultBondDenom, sdk.OneInt()), sdk.OneDec())
