...
func TestTallyDelgatorOverride(t *testing.T) {
	...
	_, err := app.StakingKeeper.Delegate(ctx, addrs[4], sdk.NewCoin(sdk.DefaultBondDenom, delTokens), stakingtypes.Unbonded, val1, true)
	require.NoError(t, err)
...
func TestTallyDelgatorInherit(t *testing.T) {
	...
	_, err := app.StakingKeeper.Delegate(ctx, addrs[3], sdk.NewCoin(sdk.DefaultBondDenom, delTokens), stakingtypes.Unbonded, val3, true)
	require.NoError(t, err)
...
func TestTallyDelgatorMultipleOverride(t *testing.T) {
	...
	_, err := app.StakingKeeper.Delegate(ctx, addrs[3], sdk.NewCoin(sdk.DefaultBondDenom, delTokens), stakingtypes.Unbonded, val1, true)
	require.NoError(t, err)
	_, err = app.StakingKeeper.Delegate(ctx, addrs[3], sdk.NewCoin(sdk.DefaultBondDenom, delTokens), stakingtypes.Unbonded, val2, true)
	require.NoError(t, err)
...
func TestTallyValidatorMultipleDelegations(t *testing.T) {
	...
	_, err := app.StakingKeeper.Delegate(ctx, addrs[0], sdk.NewCoin(sdk.DefaultBondDenom, delTokens), stakingtypes.Unbonded, val2, true)
	require.NoError(t, err)
